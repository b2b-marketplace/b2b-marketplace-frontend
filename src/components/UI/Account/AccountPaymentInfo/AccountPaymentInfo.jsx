  ...
  return (
    <section className="accountpaymentinfo">
      ...
      <ul className="accountpaymentinfo__list">
        <li className={isMain ? "accountpaymentinfo__item accountpaymentinfo__item-main" : "accountpaymentinfo__item"}>
          <div className="accountpaymentinfo__item-container">
            <div className="accountpaymentinfo__checkbox-zone">
              <div className={isMain ? "accountpaymentinfo__logo-block accountpaymentinfo__logo-block-main" : "accountpaymentinfo__logo-block"}>
                <img className="accountpaymentinfo__logo" src={visa} alt="Название платежной системы"></img>
              </div>
              <input 
                className={isMain ? "accountpaymentinfo__checkbox accountpaymentinfo__checkbox-main" : "accountpaymentinfo__checkbox"} 
                type='checkbox'
                id="input1"
                onClick={changeMain}></input>
            </div>
            <div className={isMain ? "accountpaymentinfo__number-about accountpaymentinfo__number-about-main" : "accountpaymentinfo__number-about"}>
              ...
              <div className="accountpaymentinfo__number-zone">
                ...
                <button className="accountpaymentinfo__delete">
                  {isMain ? <IconClose className="accountpaymentinfo__delete-button_ligth"/> : <IconClose className="accountpaymentinfo__delete-button" />}
                </button>
              </div>
            </div>
          </div>

      ...
      <ol className="privacy-policy-page__lists">
        ...
        <li className="privacy-policy-page__list">
          ...
          <p className="privacy-policy-page__text">
            ...
            по обеспечению безопасности персональных данных, предпринимаемые OOO "B2Buy" (далее —
            Оператор).
          </p>
          <p className="privacy-policy-page__text">
          ...
          <p className="privacy-policy-page__text">
            ...
            веб-сайта https://B2Buy.ru.
          </p>
          <p className="privacy-policy-page__text">2. Основные понятия, используемые в Политике</p>
          <p className="privacy-policy-page__text">
        ...
        <li className="privacy-policy-page__list">
          ...
          <p className="privacy-policy-page__text">3.1. Оператор имеет право:</p>
          <p className="privacy-policy-page__text">
          ...
          <p className="privacy-policy-page__text">3.2. Оператор обязан:</p>
          <p className="privacy-policy-page__text">
        ...
        <li className="privacy-policy-page__list">
          ...
          <p className="privacy-policy-page__text">
            — на отзыв согласия на обработку персональных данных, а также, на направление требования
          ...
          <p className="privacy-policy-page__text">4.2. Субъекты персональных данных обязаны:</p>
          <p className="privacy-policy-page__text">
        ...
        <li className="privacy-policy-page__list">
          ...
          <p className="privacy-policy-page__text">
            ...
            электронной почты Оператора B2Buy@gmail.com с пометкой «Актуализация персональных
            данных».
          </p>
          <p className="privacy-policy-page__text">
            ...
            электронный адрес Оператора B2Buy@gmail.com с пометкой «Отзыв согласия на обработку
            персональных данных».
          </p>
          <p className="privacy-policy-page__text">
        ...
        <li className="privacy-policy-page__list">
          <h3 className="privacy-policy-page__subtitle">Конфиденциальность персональных данных</h3>
          <p className="privacy-policy-page__text">
        ...
        <li className="privacy-policy-page__list">
          <h3 className="privacy-policy-page__subtitle">Заключительные положения</h3>
          <p className="privacy-policy-page__text">
